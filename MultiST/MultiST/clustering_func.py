...
def leiden(adata, n_clusters, key_added='MultiST', random_seed=2023):
...
def louvain(adata, n_clusters, key_added='MultiST', random_seed=2023):
    sc.pp.neighbor(adata, use_rep=use_rep)
...
def mclust_R(adata, n_clusters, use_rep='MultiST', key_added='MultiST', random_seed=2023):
    """\
    Clustering using the mclust algorithm.
    The parameters are the same as those in the R package mclust.
    """
    import os
    # os.environ['R_HOME'] = '/home/wang3wa/.conda/envs/wei/bin/R'
